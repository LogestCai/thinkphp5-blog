...
return [
   ...
   //'exception_tmpl'         => APP_PATH.'error.html'
    ...
    'siteconfig'=>[
        'indexLstNumber'=>8, //首页默认展示推荐条数
        'listLstNumber' =>8, //列表页默认展示条数
        'tagNumber' =>15, //列表页默认展示条数
        'suggestTitleLength' =>'10', //推荐文章标题显示长度
        'contentDescLength' =>'200', //文章描述最大展示数字
        'keywords' =>'青草根博客,php技术博客,it技术分享,程序开发资源分享',
        'title' =>'IT界-青草根,青草根博客,程序员技术博客,it技术交流',
    ],
];